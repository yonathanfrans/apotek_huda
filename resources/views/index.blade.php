...
<div id="animation-carousel" class="relative w-full max-w-screen-xl mx-auto my-16" data-carousel="slide">
  ...
  <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
    ...
    <div class="hidden duration-500 ease-in-out" data-carousel-item>
      <img src="assets/img/carousel-1.webp" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="carousel-1">
    </div>
    <!-- Item 2 -->
    <div class="hidden duration-500 ease-in-out" data-carousel-item>
      <img src="assets/img/carousel-2.webp" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="carousel-2">
    </div>
    <!-- Item 3 -->
    <div class="hidden duration-500 ease-in-out" data-carousel-item>
      <img src="assets/img/carousel-3.webp" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="carousel-3">
    </div>
  </div>
  <!-- Slider controls -->
  <button class="absolute top-1/2 left-0 z-30 flex items-center justify-center px-8 cursor-pointer group focus:outline-none transform -translate-y-1/2" data-carousel-prev>
    <svg class="w-4 h-4 text-white rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 1 1 5l4 4" />
    </svg>
  </button>

  <button class="absolute top-1/2 right-0 z-30 flex items-center justify-center px-8 cursor-pointer group focus:outline-none transform -translate-y-1/2" data-carousel-next>
    <svg class="w-4 h-4 text-white rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
...
<div class="max-w-screen-xl mx-auto my-10 py-3 bg-white border border-gray-300 rounded-lg shadow-xl ">
  <div class="flex items-center justify-between px-9">
    ...
    <button data-modal-target="default-modal" data-modal-toggle="default-modal" class="inline-flex font-normal place-items-center text-black gap-4 bg-second-color py-1 px-3 rounded-full">
      Tampilkan Semua
...
<div id="default-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
  <div class="bg-white rounded-xl max-w-3xl p-6 space-y-4 shadow-lg bg-no-repeat bg-center" style="background-image: url('assets/img/modal-apotek.webp'); background-size: 40%;">
    <!-- Judul Modal -->
    <div class="flex items-center justify-between px-4">
      <h2 class="text-xl font-bold text-gray-800 cursor-default">KATEGORI</h2>
      <svg class="w-4 h-4 text-gray-400 cursor-pointer" data-modal-hide="default-modal" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
