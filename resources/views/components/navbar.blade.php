<nav class="bg-main-color border-gray-200">
...
<nav class='py-5 bg-main-color max-h-max flex justify-around items-center px-20 sticky top-0 z-50'>
    ...
    <!-- logo -->
     <a href="/">
         <img src="{{ asset('assets/img/logo.webp') }}" alt="logo" class="h-12">
     </a> --}}
...
{{-- <div class="flex gap-x-10">
        <a href="/" class="text-white font-semibold text-md hover:text-gray-300 transition-colors">
            Beranda
        </a>
        <a href="/products" class="text-white font-semibold text-md hover:text-gray-300 transition-colors">
            Products
        </a>
    </div> --}}
...
{{-- <div class="flex justify-center gap-x-10">
        ...
        <div id="cart-icon" class="relative group inline-block">
            ...
            <div
                class="absolute inline-flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-third-color border-1 border-white rounded-full -top-1 -end-2">
                1</div> --}}

<!-- Popover -->
{{-- <div data-popover id="popover-bottom" role="tooltip"
                class="p-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible absolute left-1/2 transform -translate-x-1/2 transition-opacity duration-300 w-max max-h-64 bg-gray-100 text-gray-800 border border-gray-300 rounded-lg shadow-lg z-10">
                <!-- product card -->
                <div id="popover-content" class="flex flex-row w-full h-full max-w-xs rounded-xl border-2 border-gray-300 bg-white">
                        ...
                        <div class="flex items-center gap-x-2 pb-1">
                            ...
                            <div class="flex items-center ml-5">
                                <button type="button" id="decrement-button"
                                    ...
                                    <svg class="w-2.5 h-2.5 text-main-color" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 2">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="2" d="M1 1h16" />
                                    </svg>
                                </button>
                                <input type="text" id="counter-input" data-input-counter data-input-counter-min="0"
                ...
                <div
                    class="flex justify-between -mx-2 px-4 py-3 border-y-2 border-gray-300 bg-white mt-10 text-lg font-bold">
                    <h3>Total : </h3>
                ...
                <!-- arrow -->
                <div
                    class="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-2 h-2 bg-white border-t border-l border-gray-300 rotate-45">
                </div>
            </div> --}}
{{-- </div>
