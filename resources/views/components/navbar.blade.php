...
<nav class='py-5 bg-main-color max-h-max flex justify-around items-center px-20 sticky top-0 z-50'>
    ...
    <div class="flex justify-center gap-x-10">
        ...
        <a href="{{ route('login') }}"
            class="group px-3 py-2 text-md text-white font-semibold inline-flex items-center border-2 border-white rounded-lg bg-main-color hover:bg-white hover:text-main-color">
            <svg class="w-6 h-6 me-2 text-white group-hover:text-main-color" aria-hidden="true"
