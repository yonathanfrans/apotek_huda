                                    ...
                                    <div
                                        ...
                                        <div class="px-4">
                                            ...
                                            <div class="flex items-center gap-5 my-2">
                                                ...
                                                <span
                                                    class="text-xs text-red-600 font-bold bg-pink-200 px-1">20%</span>
                                            </div>
                                            ...
                                            <button
                                                class="mt-2 mb-4 w-full text-sm font-medium text-white bg-green-500 rounded-md py-3 hover:bg-green-600">
                                                Tambah ke Keranjang
                                            </button>
                                        </div>
                                    </div>
